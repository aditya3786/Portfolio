            ...
            >
              <div className="relative z-10">
                ...
                <div className="flex justify-center gap-4">
                  ...
                  <a href="mailto:adityapathania2@gmail.com" className="w-12 h-12 bg-apple-gray-800 rounded-full flex items-center justify-center hover:bg-apple-gray-700 hover:scale-105 transition-all duration-200 cursor-pointer">
